...
namespace Controller
{
    public class Payment_cart
    {
        ...
        private string htmlEmalHeader(string _cusName,string _code)
        {
            ...
            _res.Append("<div>");
            _res.Append("<div class='wrap head' style='background: #f4f3f3; width: 600px;padding: 10px 0; position: relative'> <a href='http://esell.vn'><img src='http://esell.vn" + _imglogo + "' alt='' width='150' /></a> <div class='hotline' style='position: absolute; top: 0; right: 0;color: #FF0000;font-size: 18px;background: url(http://esell.vn/vi-vn/Images/phone_ico.png) 0 center no-repeat;padding-left: 28px;margin-top: 10px;'><b>0908.169.044</b></div> </div>");
            _res.Append("</div>");
            _res.Append("<div class='wrap' style='width: 600px;margin: 0 auto'>");
            _res.Append("<p><strong>Chào "+_cusName+",</strong></p>");
            _res.Append("<p>Chúng  tôi đã nhận được đơn đặt hàng của bạn tại &nbsp;<a href='http://www.esell.vn'>www.esell.vn</a></p>");
        ...
        private string htmlEmailFooter(string _totalamountFirst,string _ship,string _totalfilnal,string _hinhthuc, string _address,string _email,string _phone,string _note)
        {
            ...
            _res.Append("<p>Esell.vn cảm ơn và rất  mong tiếp tục nhận được sự ủng hộ của bạn</p>");
            _res.Append("</div>");
            _res.Append("<div style='background: #414141; text-align: center; padding: 5px 0; color: #FFFFFF'>");
            _res.Append("<div class='wrap'>");
            _res.Append("<p><strong>Chúng tôi luôn sẵn sàng hỗ trợ bạn qua email <a href='mailto:info@esell.vn' style='color: #FFFFFF'>info@esell.vn</a> và hotline: 0908.169.044</strong></p>");
